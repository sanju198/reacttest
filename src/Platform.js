         ...
         <p type="button" class="btn warning-color-dark btn-lg btn-block text-white">SHAREPOINT 2013,2016 AND 2019</p>
           <MDBCardBody>
             ...
             <ul>
                 ...
                 <li><a href className="dropdown-item">Microsoft PowerApps</a></li>
								 <li><a href className="dropdown-item">Solution Customization and Enhancement</a></li>
                 <li><a href className="dropdown-item">Migration and Upgrade</a></li>
                 <li> <a href className="dropdown-item">Services and Application monitoring<br/> and escalations</a></li>
         ...
         <p type="button" class="btn warning-color-dark btn-lg btn-block text-white">Documentum</p>
           <MDBCardBody>
             ...
             <ul>
                 ...
                 <li><a href className="dropdown-item">xCP 2.x, 16.x Development and Enhancement</a></li>
								 <li><a href className="dropdown-item">D2 Application Development<br/> and Enhancement</a></li>
                 <li><a href className="dropdown-item">Migration and Upgrade</a></li>
                 <li> <a href className="dropdown-item">Services and Application monitoring <br/> and escalations</a></li>
